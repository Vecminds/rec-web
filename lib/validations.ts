...
export const talentFormSchema = z.object({
  ...
  primary_role: z
    ...
    .max(100, "Role selection is too long")
    .refine(
      (v) =>
        [
          "Backend Engineer",
  ...
  years_experience: z
    ...
    .max(100, "Experience selection is too long")
    .refine(
  ...
  employment_status: z
    ...
    .max(100, "Status selection is too long")
    .refine(
      (v) =>
...
export const companyFormSchema = z.object({
  ...
  company_size: z
    ...
    .max(100, "Company size selection is too long")
    .refine(
  ...
  role_type: z
    ...
    .max(100, "Role type selection is too long")
    .refine(
      (v) =>
        [
          "Backend Engineer",
  ...
  seniority_level: z
    ...
    .max(100, "Seniority selection is too long")
    .refine(
      (v) =>
  ...
  number_of_roles: z
    ...
    .max(100, "Number of roles selection is too long")
    .refine(
  ...
  employment_type: z
    ...
    .max(100, "Employment type selection is too long")
    .refine(
      (v) =>
  ...
  work_arrangement: z
    ...
    .max(100, "Work arrangement selection is too long")
    .refine(
