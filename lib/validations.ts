...
export const talentFormSchema = z.object({
  ...
  linkedin_url: z
    ...
    .refine((url) => url.toLowerCase().startsWith("http://") || url.toLowerCase().startsWith("https://"), "URL must start with http:// or https://")
    .refine(
  ...
  github_url: z
    ...
    .url("Please enter a valid URL")
    .refine((url) => url === "" || url.toLowerCase().startsWith("http://") || url.toLowerCase().startsWith("https://"), "URL must start with http:// or https://")
    .optional()
    .or(z.literal("")),
  ...
  years_experience: z
    ...
    .max(100, "Years of experience must be under 100 characters")
    .refine(
  ...
  employment_status: z
    ...
    .max(100, "Employment status must be under 100 characters")
    .refine(
      (v) =>
...
export const companyFormSchema = z.object({
  ...
  company_size: z
    ...
    .max(100, "Company size must be under 100 characters")
    .refine(
  ...
  role_type: z
    ...
    .max(100, "Role type must be under 100 characters")
    .refine(
      (v) =>
        [
          "Backend Engineer",
  ...
  seniority_level: z
    ...
    .max(100, "Seniority level must be under 100 characters")
    .refine(
      (v) =>
  ...
  number_of_roles: z
    ...
    .max(100, "Number of roles must be under 100 characters")
    .refine(
  ...
  work_arrangement: z
    ...
    .max(100, "Work arrangement must be under 100 characters")
    .refine(
